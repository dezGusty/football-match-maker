...
export const routes: Routes = [
    ...
    {
        path: 'select-players',
        loadComponent: () => import('./pages/selectPlayers/select-players.component').then(m => m.SelectPlayersComponent),
        canActivate: [authGuard]
    },
    {
        path: 'account',
    ...
    },
    {
        ...
        loadComponent: () => import('./pages/match-formation/match-formation.component').then(m => m.MatchFormationComponent),
        canActivate: [authGuard]
    },
    {
